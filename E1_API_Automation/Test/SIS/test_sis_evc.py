...
class TestSisEVCService:
    ...
    def create_service(self):
        self.service = SISEVCService('https://internal-e1-evc-booking-qa-cn.ef.com')

    @Test()
    def test_enroll_course(self):
        response = self.service.enroll_course_credits(12226094, ["HF"])
        assert_that(response.status_code, equal_to(204))
        assert_that(response.content, equal_to(b''))

    @Test()
    def test_get_teacher_profile_response_status(self):
        response = self.service.get_teacher_profiles([10366576, 10703777])
    ...
    def test_get_teacher_profile_schema(self):
        response = self.service.get_teacher_profiles([10703777]).json()[0]
        ...
        assert_that(jmespath.search('teacherId', response), equal_to(10703777))

    @Test()
    def test_student_credit_status(self):
        response = self.service.get_student_credits(12226094)
        assert_that(response.status_code,equal_to(200))
    ...
    def test_get_available_time_slots_status(self):
        response = self.service.get_available_time_slot(30,12226094,'HF','Regular')
        assert_that(response.status_code,equal_to(200))
    ...
    def test_get_available_time_slots_schema(self):
        response = self.service.get_available_time_slot(30, 12226094, 'HF', 'Regular').json()[0]
    ...
    def test_get_available_time_slots_logic(self):
        response = self.service.get_available_time_slot(30, 12226094, 'HF', 'Regular').json()
    ...
    def test_get_bookable_class_status(self):
        response = self.service.get_available_class(30, 12226094, 'HF', 'Regular')
        assert_that(response.status_code, equal_to(200))

    @Test()
    def test_get_bookable_class_schema(self):
        response = self.service.get_available_class(30, 12226094, 'HF', 'Regular').json()[0]
    ...
    def test_get_class_info(self):
        available_class = self.service.get_available_class(30, 12226094, 'HF', 'Regular').json()[0]
    ...
    def test_get_student_booking_history_status(self):
        history = self.service.get_student_book_history(12226094,'2018-02-01','Hf',"Regular")
        assert_that(history.status_code, equal_to(200))

    @Test()
    def test_get_student_booking_history_schema(self):
        history = self.service.get_student_book_history(12226094, '2018-02-01', 'Hf', "Regular").json()
    ...
    def test_get_student_credits_history_status(self):
        response = self.service.get_student_credit_history(12226094)
        assert_that(response.status_code, equal_to(200))

    @Test()
    def test_get_student_credits_history_schema(self):
        response = self.service.get_student_credit_history(12226094).json()[0]
