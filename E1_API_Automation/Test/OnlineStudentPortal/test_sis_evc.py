...
test_student_id = {'QA': 12226094, 'Staging': 43195098}
test_teacher_ids = {'QA': [10703777, 10366576], 'Staging': [10584669, 10427158]}
...
class TestSisEVCService:
    ...
    def test_enroll_course(self):
        response = self.service.enroll_course_credits(test_student_id[env_key], ["HF"])
        assert_that(response.status_code, equal_to(204))
        r = self.service.get_student_credits(test_student_id[env_key])
    ...
    def test_get_teacher_profile_response_status(self):
        response = self.service.get_teacher_profiles(test_teacher_ids[env_key])
    ...
    def test_get_teacher_profile_schema(self):
        response = self.service.get_teacher_profiles(test_teacher_ids[env_key]).json()
        ...
        assert_that(response_ids, equal_to(sorted(test_teacher_ids[env_key])))

    @Test()
    def test_student_credit_status(self):
        response = self.service.get_student_credits(test_student_id[env_key])
        assert_that(response.status_code, equal_to(200))
    ...
    def test_get_available_time_slots_status(self):
        response = self.service.get_available_time_slot(30, test_student_id[env_key], 'HF', 'Regular')
        assert_that(response.status_code, equal_to(200))
    ...
    def test_get_available_time_slots_schema(self):
        response = self.service.get_available_time_slot(30, test_student_id[env_key], 'HF', 'Regular').json()[0]
    ...
    def test_get_available_time_slots_logic(self):
        response = self.service.get_available_time_slot(30, test_student_id[env_key], 'HF', 'Regular').json()
    ...
    def test_get_bookable_class_status(self):
        response = self.service.get_available_class(30, test_student_id[env_key], 'HF', 'Regular')
        assert_that(response.status_code, equal_to(200))

    @Test()
    def test_get_bookable_class_schema(self):
        response = self.service.get_available_class(30, test_student_id[env_key], 'HF', 'Regular').json()[0]
    ...
    def test_get_class_info(self):
        available_class = self.service.get_available_class(30, test_student_id[env_key], 'HF', 'Regular').json()[0]
    ...
    def test_get_student_booking_history_status(self):
        history = self.service.get_student_book_history(test_student_id[env_key], '2018-02-01', 'Hf', "Regular")
        assert_that(history.status_code, equal_to(200))

    @Test()
    def test_get_student_booking_history_schema(self):
        history = self.service.get_student_book_history(test_student_id[env_key], '2018-02-01', 'Hf', "Regular").json()
    ...
    def test_get_student_credits_history_status(self):
        response = self.service.get_student_credit_history(test_student_id[env_key])
        assert_that(response.status_code, equal_to(200))

    @Test()
    def test_get_student_credits_history_schema(self):
        response = self.service.get_student_credit_history(test_student_id[env_key]).json()[0]
