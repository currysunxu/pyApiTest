...
class PipelinePublishTestCases:
    ...
    @Test(data_provider=[("LIVE", "highflyers", "book-8", "cn-3")])
    def test_pp_release(self, source_aem_env, course, release_book, region_ach):
        ...
        error_message = pipeline_publish_service.verify_content_after_release(aem_book_response.json(),
                                                                              content_map_book_tree, release_revision)
