...
# EVC_BACKEND_ENVIRONMENT = get_current_env('EVCBackendEnvironment')
EVC_PROXY_ENVIRONMENT = get_current_env('EVCProxyEnvironment')
EVC_MEETING_WEBSYNC_ENVIRONMENT = get_current_env('EVCMeetingWebsyncEnvironment')
EVC_MEDIA_WEBSYNC_ENVIRONMENT = get_current_env('EVCMediaWebsyncEnvironment')
MEDIA_ENVIRONMENT = get_current_env('MediaEnvironment')
