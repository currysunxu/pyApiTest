...
def unlock_service_by_read_excel_or_by_specific_key_list(product_name, env, username, password, keys, sheet_number=0, col_num=2):
    student_id_list = []
...
if __name__ == '__main__':
    ...
    unlock_service_by_read_excel_or_by_specific_key_list(product_name,env,username,password,KEY,sheet_number=0,col_num=2)


    """
    read excel to get lesson keys list.
